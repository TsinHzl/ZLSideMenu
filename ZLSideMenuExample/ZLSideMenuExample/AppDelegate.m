...
//  ZLSideMenuExample
//
//  Created by hezhonglin on 16/8/9.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ZLSideMenuController *sideVc = [[ZLSideMenuController alloc] init];
    ZLLeftViewController *leftVc = [[ZLLeftViewController alloc] init];
    ZLRightViewController *rightVc = [[ZLRightViewController alloc] init];
    sideVc.leftViewController = leftVc;
    sideVc.mainViewController = rightVc;
